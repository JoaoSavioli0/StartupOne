...
export default function NotificationsBox() {
  ...
  return (
    <>
      ...
      <OverlayPanel ref={op} showCloseIcon className="w-[200px]">
        <div className="flex flex-col">
          <p className="text-sm font-semibold border-b border-gray-200 pb-2">
            Notificações
          </p>
          ...
          <div className="flex flex-col">
            {exampleNotifications.map((notification) => (
              <div
                key={notification.id}
                className="flex flex-col py-3 border-b border-gray-200 relative"
              >
                {!notification.seen && (
